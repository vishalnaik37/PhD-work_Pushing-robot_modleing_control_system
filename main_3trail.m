...
q11=[cos(q1+q3) -sin(q1+q3)  X;sin(q1+q3) cos(q1+q3) 0 ; 0 0 1];
q12=[cos(q2) -sin(q2) sqrt(Xo^2+Yo^2);sin(q2) cos(q2) 0;0 0 1];
Pco=q11*q12*[sqrt(Xc^2+Yc1^2);0;1];
Vco=jacobian(Pco,[t1,t2,q1,X])*[t1_d;t2_d;q1_d;X_d];
Aco=jacobian(Vco,[t1,t2,q1,X,t1_d,t2_d,q1_d,X_d])*[t1_d;t2_d;q1_d;X_d;t1_dd;t2_dd;q1_dd;X_dd];
% matlabFunction(Vco,'file','R_Vco','Optimize',false);
% matlabFunction(Aco,'file','R_Aco','Optimize',false);
% matlabFunction(Pco,'file','R_EQO','Optimize',false);
Ro=simplify([cos(q1+atan2(Yo,Xo)) -sin(q1+atan2(Yo,Xo))  0;sin(q1+atan2(Yo,Xo)) cos(q1+atan2(Yo,Xo)) 0 ; 0 0 1]*[cos(q2) -sin(q2) 0;sin(q2) cos(q2) 0;0 0 1]*[sqrt(Xc^2+Yc1^2);0;1]);
G=[1 0 -Ro(2);0 1 Ro(1)];
% matlabFunction(G','file','R_Grasp','Optimize',false);
EqP=R-Pco;
% matlabFunction(EqP(1:2),'file','R_EQP','Optimize',false);
VEqP=jacobian(EqP,[t1,t2,q1,X])*[t1_d;t2_d;q1_d;X_d];
AEqP=jacobian(VEqP,[t1,t2,q1,X,t1_d,t2_d,q1_d,X_d])*[t1_d;t2_d;q1_d;X_d;t1_dd;t2_dd;q1_dd;X_dd];
