...
% X1s=0.83;
% Y10=0;Y1s=0;
function [P11,P21,P31,P41,Q11,Q12,Q13,Q14,T,XC,VPP,APP,Pco,Time,Z1]=KinAnimation2(X10,q10,q1s,X1s,Ts,Y10,Y1s,Z0)
L1=0.5;
L2=0.5;
L01=0.5;
h=0.0001;
...
EqXc =[R_EQP(L01,L1,L2,X,Xc,Xo,Y,Yo,q1,r,t1,t2)];
...
P=[R_EQO(X,Xc,Xo,Y,Yo,q1);t1;t2;q1;X;Y;Xc];
% [t1,t2]=Elbow_Up(L1,L2,P(1),P(2));
