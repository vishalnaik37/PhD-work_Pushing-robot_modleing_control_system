...
save('FFFBActual_PPos1_1.mat', 'M1_1');
save('FFFBActual_Pforce1_1.mat', 'ErrorF1');
M1_2=[Time2_';Error2Des;Error2Act;Error2RV];
save('FFFBArbitary_PPos2_1.mat', 'M1_2');
save('FFFB_Arbitary_Pfroce1_2.mat', 'ErrorF2');
