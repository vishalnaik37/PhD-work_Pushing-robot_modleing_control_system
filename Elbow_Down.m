% 2R Robot Inverse Kinematics - Elbow Up
clc;
clear;
...
x = 1.5; % x-coordinate of the end-effector
y = 0.5; % y-coordinate of the end-effector
...
% Compute theta2 for the elbow-up configuration
